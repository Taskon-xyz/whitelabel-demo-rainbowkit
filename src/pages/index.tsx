...
const Home: NextPage = () => {
  return (
    <>
      <Head>
        <title>TaskOn Embed Demo - White Label</title>
        <meta
          content="TaskOn Embed SDK demos with different login methods"
          name="description"
        />
      </Head>
          ...
          <div className="mt-16 text-center">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white/5 rounded-xl p-6 border border-white/10">
                ...
                <p className="text-gray-300 text-sm">RSA-PKCS1v15 signatures with SHA-256 for tamper-proof authentication</p>
              </div>
              <div className="bg-white/5 rounded-xl p-6 border border-white/10">
